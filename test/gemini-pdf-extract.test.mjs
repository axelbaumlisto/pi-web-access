...
// Hermetic: a developer's real ~/.pi/web-search.json (e.g. geminiApiKey /
// geminiBaseUrl) must not override the synthetic key asserted below.
process.env.PI_CODING_AGENT_DIR = mkdtempSync(join(tmpdir(), "pi-web-access-gemini-pdf-"));
